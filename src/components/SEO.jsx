...
const SEO = () => {
  ...
  return (
    <Helmet>
      ...
      <title>{title}</title>
      <link rel="apple-touch-icon" href="/favicons/logo1.png" />
      <link rel="icon" type="image/png" sizes="32x32" href="/favicons/logo1.png" />
      <link rel="icon" type="image/png" sizes="16x16" href="/favicons/logo1.png" />
